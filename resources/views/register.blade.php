...
<head>
  ...
  <title>Application - Softcenter</title>
...
<body style="background-image: url({{ url('images/img_bg_1.jpg') }});">
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="{{ url('/') }}" class="logo d-flex align-items-center w-auto">
                  <span style="color:white" class="d-none d-lg-block">SOFTCENTER</span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <p class="text-center small" style="font-weight: bold; font-size: 15px">ICT BUSINESS ACCELERATION PROGRAMME APPLICATION FORM</p>
                  </div>
